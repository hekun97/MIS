...
function show_delete(object) {
    ...
    if (object == "user") {
        ...
        show = "<div id='delete_" + object + "'  class='d_form'>"
            + "<h3>请输入删除部门信息</h3>"
            + "<input type='text' autofocus='autofocus' name='username' value placeholder='部门名称' required>"
            + "<input id='submit' onclick='delete_department()' type='button' name='submit' value='确定删除'>"
            + "</div>";
    }
    else if (object == "class") {
        show = "<div id='delete_" + object + "'  class='d_form'>"
...
function show_alter(object) {
    ...
    if (object == "user") {
        ...
        show = "<div id='alter_department'  class='d_form'>"
            + "<h3>请输入需要修改的部门信息</h3>"
            + "<p>修改前</p>"
            + "<input type='text' autofocus='autofocus' name='dno' value placeholder='部门名称' required>"
            + "<p>修改后</p>"
            + "<input type='text' name='after_dno' value placeholder='部门名称' required>"
            + "<input type='text' name='after_dname' value placeholder='部门简介'>"
...
function show_insert_department() {
    ...
    var show = "<div id='show_insert_department'  class='d_form'>"
        + "<h3>请输入新增部门信息</h3>"
        + "<input type='text' autofocus='autofocus' name='dno' value placeholder='部门名称' required>"
        + "<input type='text' name='dname' value placeholder='部门简介'>"
        + "<input id='submit' onclick=insert('department') type='button' name='submit' value='新增'>"
        + "</div>";
    result.innerHTML = show;
}
//显示新增团队
function show_insert_team() {
    var result = document.getElementById("result");
    var show = "<div id='show_insert_team'  class='d_form'>"
        + "<h3>请输入新增团队信息</h3>"
        + "<input type='text' autofocus='autofocus' name='clno' value placeholder='团队名称' required>"
        + "<input type='text' name='clname' value placeholder='团队简介'>"
        + "<input type='text' name='dno' value placeholder='所属部门名称'>"
        + "<input id='submit' onclick=insert('team') type='button' name='submit' value='新增'>"
        + "</div>";
    result.innerHTML = show;
}
//显示插入学生
